...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_user_skill_unique", "user_skill", ["user_id", "skill_id"], unique=True
    )
    op.create_table(
        "project_intern",
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.id"], name=op.f("task_skill_skill_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["task_id"], ["task.id"], name=op.f("task_skill_task_id_fkey")
        ),
        sa.PrimaryKeyConstraint("task_id", "skill_id", name=op.f("task_skill_pkey")),
    )
    op.create_index(
        op.f("ix_task_skill_unique"), "task_skill", ["task_id", "skill_id"], unique=True
    )
    op.create_table(
        "intern_skill",
        ...
        sa.ForeignKeyConstraint(
            ["intern_id"], ["intern.id"], name=op.f("intern_skill_intern_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.id"], name=op.f("intern_skill_skill_id_fkey")
        ),
        sa.PrimaryKeyConstraint(
            "intern_id", "skill_id", name=op.f("intern_skill_pkey")
        ),
    )
    op.create_index(
        op.f("ix_intern_skill_unique"),
        "intern_skill",
        ["intern_id", "skill_id"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column("note", sa.TEXT(), autoincrement=False, nullable=True),
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.id"], name=op.f("supervisor_skill_skill_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["supervisor_id"],
            ["supervisor.id"],
            name=op.f("supervisor_skill_supervisor_id_fkey"),
        ),
        sa.PrimaryKeyConstraint(
            "supervisor_id", "skill_id", name=op.f("supervisor_skill_pkey")
        ),
    )
    op.create_index(
        op.f("ix_supervisor_skill_unique"),
        "supervisor_skill",
        ["supervisor_id", "skill_id"],
        unique=True,
    )
