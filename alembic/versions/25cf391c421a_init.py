...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_intern_skill_unique", "intern_skill", ["intern_id", "skill_id"], unique=True
    )
    op.create_table(
        "project",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_intern_task_unique", "intern_task", ["intern_id", "task_id"], unique=True
    )
    op.create_table(
        "note",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_task_skill_unique", "task_skill", ["task_id", "skill_id"], unique=True
    )
